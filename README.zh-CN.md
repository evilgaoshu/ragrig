...
11. `source.s3` 已支持真实 S3-compatible Markdown/Text 入库，默认测试仍保持 fake-client-first。
...
Phase 1e PR-1 已经建立 `src/ragrig/providers/` 的 core contract。
...
- Ollama / LM Studio 真实 adapter
- BGE embedding / reranker adapter
- cloud provider stub

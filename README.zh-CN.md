...
| 优先级 | 插件方向 | 优先支持平台/协议 |
| --- | --- | --- |
| P0 | `vector.qdrant` | [Qdrant Cloud](https://qdrant.tech/cloud/)、[自托管 Qdrant](https://qdrant.tech/documentation/) |
| P0 | `model.openai_compatible` | [OpenAI](https://platform.openai.com/docs/overview)、[Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)、[vLLM](https://www.vllm.ai/)、[Ollama](https://ollama.com/)、[LM Studio](https://lmstudio.ai/)、[Xinference](https://inference.readthedocs.io/)、[llama.cpp](https://github.com/ggml-org/llama.cpp) server |
| P0 | `embedding.bge` / `reranker.bge` | [BAAI BGE](https://huggingface.co/BAAI) embedding 与 reranker，本地或 OpenAI-compatible serving |
